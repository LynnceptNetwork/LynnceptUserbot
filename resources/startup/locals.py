...
def start():
    ...
    print(f"{a}\n\n")
    print("Welcome to LynnceptNetwork, lets start setting up!\n\n")
    print("Cloning the repository...\n\n")
    os.system("rm -rf Ultroid")
    os.system("git clone https://github.com/LynnceptNetwork/LynnceptUserbot")
    print("\n\nDone")
    os.chdir("Ultroid")
    clear_screen()
    print(a)
    ...
    if isitdone == "y" or isitdone != "n":
        # https://github.com/LynnceptNetwork/LynnceptUserbot/blob/31b9eb1f4f8059e0ae66adb74cb6e8174df12eac/resources/startup/locals.py#L35
        f = open(".env", "w")
        f.write(all_done)
    else:
...
def gen_session():
    print("\nProcessing...")
    # https://github.com/LynnceptNetwork/LynnceptUserbot/main/resources/startup/locals.py#L35
