...
# PLease read the GNU Affero General Public License in <https://github.com/LynnceptNetwork/LynnceptUserbot/blob/main/LICENSE/>.
...
should_start(){
    ...
    git clone https://github.com/LynnceptNetwork/LynnceptUserbot
    cd Ultroid
    clear
